...
const postSlice = createSlice({
    ...
    reducers: {
        ...
        likeOrDeslike: (state, action: PayloadAction<{ postId: string; userId: string }>) => {
...
export const { setPosts, addPost, deletePost, likeOrDeslike, addComment } = postSlice.actions
